...
$(document).ready(function() {
  ...
  $(".request-btn .decline").on("click", function() {
    $(this)
      .closest(".row")
      .find(".request-notification-container .num")
      .html(
        $(this)
          .closest(".all-history-items")
          .find(".request-item-container").length - 1
      );
    $(this)
      .closest(".request-item-container")
      .remove();
  });
  ...
  $(".car-option").on("click", function() {
    ...
    $(".about-section ." + $(this).data("about-target-id")).removeClass(
      "hidden"
    );
  });
  ...
  $(".requested-car-info .request-btn").on("click", function() {
    ...
    setTimeout(function() {
      ...
      $(".pending-icon")
        .addClass("approved-icon")
        .removeClass("pending-icon");
  ...
  $(document).on(
    "click",
    ".pickup-btn-container .approved-icon.call",
    function() {
      $(this).addClass("in-process");
      $(this)
        .find("button")
  ...
  $(document).on(
    "click",
    ".driver-information .approved-icon.call",
    function() {
      $(this).addClass("in-process");
      $(this)
        .find("button")
  ...
  $(document).on(
    "click",
    ".ride-status .approved-icon.call.in-process",
    function() {
  ...
  $(document).on(
    "click",
    ".pickup-btn-container .approved-icon.call.in-process",
    function() {
      $(this).removeClass("in-process");
      $(this)
        .find("button")
  ...
  $(document).on(
    "click",
    ".driver-information .approved-icon.call.in-process",
    function() {
      $(this).removeClass("in-process");
      $(this)
        .find("button")
  ...
  $(".payment-options-intro-container").on(
    "click",
  ...
  $(document).on(
    "click",
    ".payment-ready-btn span.fa-times",
    togglePaymentOptionsContainer
  );
  ...
  $(document).on("click", ".sign-in-item.border-bottom-light-grey", function() {
    $(".sign-in-item")
      .removeClass("border-bottom-primary-100")
      .addClass("border-bottom-light-grey");
    $(this)
      .removeClass("border-bottom-light-grey")
      .addClass("border-bottom-primary-100");
  ...
  $(".settings-container .slider").on("click", function() {
    ...
    $(this)
      .closest(".setting-wrapper-1")
      .addClass(className)
      .removeClass(classNameRemove);
    $(this)
      .closest(".setting-wrapper-2")
      .addClass(className)
      .removeClass(classNameRemove);
    $(this)
      .closest(".setting-wrapper-primary")
      .addClass(className)
      .removeClass(classNameRemove);
  });
  ...
  $(document).on("click", ".request-ride-info .slide-up", function() {
    ...
    if ($(this).hasClass("double-up")) {
      $(this)
        .find("img")
        .attr("src", "../icons/downarrow.svg");
      $(this)
        .removeClass("double-up")
        .addClass("double-down");
    } else {
      $(this)
        .find("img")
        .attr("src", "../icons/uparrow.svg");
      $(this)
        .removeClass("double-down")
        .addClass("double-up");
    }
  ...
  $(document).on("click", ".pick-up", function() {
    ...
    if (!$(".slide-up").hasClass("expanded")) {
      $(".request-ride-info .addresses-container")
        ...
        .removeClass("border-bottom-primary")
        .addClass("hidden");
  ...
  $(".submit-review .close-review")
    .add(".submit-review .btn-primary")
    .on("click", function() {
      $(this)
        .closest(".map-input")
        .find("input")
  ...
  $(".load-more").on("click", function() {
    ...
    $(".all-sales-history-items .sales-history-item").each(function() {
      if (counter < 2) {
        $(".all-sales-history-items").append(
...
function togglePaymentOptionsContainer() {
  if (
    $(".payment-options-intro-container").find(".fa-chevron-down").length == 0
  ) {
    $(".payment-options-intro-container")
      .find(".fa-chevron-up")
      .removeClass("fa-chevron-up")
      .addClass("fa-chevron-down");
    $(".payment-ready-btn span").text("Ready");
    $(".payment-ready-btn .close")
      .removeClass("hidden")
      .addClass("ready");
...
function multipleRoute(directionsService, directionsDisplay) {
  ...
  var coordinates = [{ lat: 42.270857, lng: -71.80952 }];
  var icons = {
  ...
  makeMarker({ lat: 42.25145, lng: -71.819469 }, icons.end, "Route End");
  ...
  for (i = 0; i < legs.length; i++) {
    ...
    for (j = 0; j < steps.length; j++) {
      ...
      var stepPolyline = new google.maps.Polyline(
        i > 0 ? polylineOptions[1] : polylineOptions[0]
      );
...
function sendChat() {
  ...
  if (text.trim().length > 0) {
    var newDom =
      ...
      $(".left-align-message.example").html() +
      "</div>";
    $(".chat-container").append(newDom);
    $(".chat-container .left-align-message:last-child")
...
function showMapRequestPin() {
  ...
  setTimeout(function() {
    if (
      !$("img[src='../icons/car-start-position.svg']")
        .parent()
        .hasClass("pulse")
    ) {
      $("img[src='../icons/car-start-position.svg']")
...
function AutocompleteDirectionsHandler(map) {
  ...
  this.directionsDisplayMap = new google.maps.DirectionsRenderer({
    suppressMarkers: true
  });
  ...
  var destinationInputContainer = document.getElementById(
      ...
      if (status === "OK") {
        ...
        setTimeout(function() {
          ...
          currents.each(function(index, current) {
            if (
              !$(current).hasClass("pulse current-location") &&
              !$(current).hasClass("map-input-icon")
            ) {
              $(current)
                .addClass("pulse current-location")
                .css("opacity", 1);
            }
          });
        }, 600);
